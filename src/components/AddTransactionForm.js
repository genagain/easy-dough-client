...
function AddTransactionForm({setToggleCreate}) {
  ...
  return (
    <div className="flex flex-col m-auto w-3/4 lg:w-full lg:flex-row lg:items-center">
        ...
        <button className="w-full lg:w-48 lg:h-12 m-2 p-6 bg-blue-600 hover:bg-blue-500 text-white rounded-lg lg:my-2 lg:p-2 text-5xl lg:text-lg" onClick={handleAddTransaction}>Create Transaction</button>
    </div>
  )
}
