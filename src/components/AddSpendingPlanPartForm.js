...
function AddSpendingPlanPartForm({ category, setShowAddSpendingPlanPartForm }) {
  ...
  return (
    <div>
      ...
      <input id="label-expected-amount" className="w-full lg:w-auto m-2 p-6 text-5xl border border-gray-400 rounded lg:max-w-sm lg:my-4 lg:p-2 lg:text-lg" placeholder="400" onChange={ e => setExpectedAmount(e.target.value) }/>
