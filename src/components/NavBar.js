      ...
      <div className="container mx-auto px-6 py-4">
        ...
        <div className="md:flex-grow"></div>
          ...
          accessToken ? 
           ...
           (
             <>
               <Link to='/signup' className={`${showAuth ? null : 'invisible'} text-4xl md:visible md:text-2xl md:px-4`}>
                 Sign Up
               </Link>
               <Link to='/login' className={`${showAuth ? null : 'invisible'} text-4xl md:visible md:text-2xl md:px-4`}>
                 Login
               </Link>
             </>
           )
