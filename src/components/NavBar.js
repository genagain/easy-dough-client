...
function NavBar() {
    ...
    return (
      ...
      <div className="container mx-auto px-6 py-8 w-10/12 lg:px-0 lg:py-3">
        ...
        <button type="button" onClick={toggleShowAuth} className={ showLinks ? "text-gray-500" : "outline-none"} aria-label="toggle menu">
          ...
          accessToken ? 
           (
            <>
              <NavLink to='/transactions' className={`${showLinks ? null : 'hidden'} text-blue-800 my-2 py-2 text-4xl lg:inline-block lg:text-2xl lg:mx-4 lg:px-4 hover:text-blue-600`} activeClassName="font-bold hover:text-blue-800" >
               Transactions
             </NavLink>
