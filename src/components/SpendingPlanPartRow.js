  ...
  return (
    <div id={`spending-plan-part-${id}`} className="lg:border-gray-600 lg:border-t">
    {
      ...
      (
        ...
        <button className={`${ category !== "Discretionary Spending" ? 'w-1/12 lg:w-1/12' : 'w-4/12 lg:w-2/12' } text-blue-800 hover:text-blue-700 text-3xl lg:text-base`} onClick={() => setToggleForm(true)}>Edit</button>
        {
