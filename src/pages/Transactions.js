    ...
    <div className="flex flex-col">
      <div className="m-auto lg:w-10/12">
        ...
        <div className="lg:m-auto">
          ...
          <button className="m-2 p-6 border border-gray-400 rounded-lg lg:my-2 lg:p-2 text-5xl lg:text-lg" onClick={ searchHandler }>Search</button>
          <button className="m-2 p-6 border border-gray-400 rounded-lg lg:my-2 lg:p-2 text-5xl lg:text-lg" onClick={ () => { setToggleCreate(!toggleCreate)} }>{ toggleCreate ? 'Hide Transaction' : 'Add Transaction' }</button>
          </div>
          </div>
      </div>
    </div>
