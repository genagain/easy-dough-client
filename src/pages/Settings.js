  ...
  return (
    <div className="flex flex-col">
      <div className="m-auto w-10/12 lg:max-w-6xl">
        ...
        <BanksList allBanks={[]} />
        <button className="w-full lg:w-24 p-6 bg-blue-800 hover:bg-blue-700 text-white rounded-lg lg:my-2 lg:p-2 text-5xl lg:text-base" onClick={() => open()} disabled={!ready}>Link Bank</button>
      </div>
    </div>
  )
}
