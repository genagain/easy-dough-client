...
function Login() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <button onClick={handleDemoLogin} className="m-auto my-6 py-6 px-6 border border-gray-400 rounded-lg text-5xl lg:my-2 lg:p-2 text-4xl lg:text-lg">Demo Log In</button>
    </div>
