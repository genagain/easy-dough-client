...
function Login() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <button onClick={handleDemoLogin} className="m-auto w-84 lg:w-32 my-6 py-6 px-6 border border-blue-800 hover:border-blue-600 rounded-lg text-blue-800 hover:text-blue-600 text-5xl lg:my-2 lg:p-2 text-4xl lg:text-lg">Demo Log In</button>
    </div>
